...
// getters
const getters = {
    GET_ROOM_LIST: state => state.roomData
};

// actions
const actions = {
    // [constant.GET_ROOM_LIST]: (store) => {
    //     console.log('1111');
    //     store.commit('GET_ROOM_LIST', roomData);
    // },
    getRoomList(context) {
        console.log('1111');
...
const mutations = {
    [constant.GET_ROOM_LIST]: (state, roomData) => {
        ...
        console.log(totalRoomLen);
        // const msgData = state.msgData.filter(item => parseInt(item.roomId) === parseInt(roomId))[0];
    ...
    [constant.SEND_MSG]: (state, params) => {
        ...
        // chatList['roomInfo'] = {...chatList['roomInfo'], params};
    ...
    [constant.GET_CHAT_DATA]: (state, roomId) => {
        ...
        console.log('state.charData : '+ JSON.stringify(state.chatData) );
        ...
        console.log('state.charData : '+state.chatData);

        // returnData.push(localImgList);
        // returnData.push(state.chatData);
        // res(returnData);
        // return returnData;
    },
};
